...
map('n', '<Leader>conf', ':e ~/.config/nvim/lua/plugins.lua<Cr>', {noremap=true, silent=true})
map('n', '<Leader>plug', ':e ~/neovim-plugins/gerrit-review.nvim/<Cr>', {noremap=true, silent=true})
